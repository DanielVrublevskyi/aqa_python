...
wh_3 = total - 250449
wh_1 = total - 222950
wh_2 = total - wh_1 - wh_3
print("first warehouse: ", wh_1)
print("second warehouse: ", wh_2)
print("third warehouse: ", wh_3)
...
full_tanks = fuel_needed // tank
refuel_stops = full_tanks - 1
